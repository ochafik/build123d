...
for i in _orange(0, 36, 1):
    for j in _orange(0, 36, 1):
        _parts.append(_colored((Pos(i, j, 0) * Box(1, 1, (11 + ((10 * _cos((10 * i))) * _sin((10 * j)))), align=(Align.MIN, Align.MIN, Align.MIN))), Color((0.5 + (_sin((10 * i)) / 2)), (0.5 + (_sin((10 * j)) / 2)), (0.5 + (_sin((10 * ((i + j)))) / 2)), 1.0)))
