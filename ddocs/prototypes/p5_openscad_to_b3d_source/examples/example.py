...
def _mod_foo(x):
    _parts = []
    for i in _orange(0, foo(x), 2):
        for j in _orange(-3, 1, 0.1):
            _parts.append((Pos(i, j, 0) * Box(0.5, 0.5, 0.5, align=(Align.MIN, Align.MIN, Align.MIN))))
...
n = 10
_parts.append(_mod_foo(10))
_parts.append(_mod_foo(20))
