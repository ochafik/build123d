...
_parts.append(_colored(Cone(7, 5, 15), Color('red')))
_parts.append(_colored((Pos(20, 0, 0) * Pos(0, 0, 15 / 2) * Cylinder(7, 15)), Color('blue')))
_parts.append(_colored((Pos(10, 20, 0) * Cylinder((10 / 2), 2)), Color('green')))
